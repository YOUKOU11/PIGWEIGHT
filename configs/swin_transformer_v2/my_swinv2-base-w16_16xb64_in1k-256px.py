...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_prefix='../data/my_dataset/train_filelist/',
    ...
    val=dict(
        type=dataset_type,
        data_prefix='../data/my_dataset/val_filelist/',
    ...
    test=dict(
        type=dataset_type,
        data_prefix='../data/my_dataset/test_filelist/',
...
lr_config = dict(policy='step', step=[5, 60])
runner = dict(type='EpochBasedRunner', max_epochs=100)
checkpoint_config = dict(interval=1000)
log_config = dict(interval=40, hooks=[dict(type='TextLoggerHook')], metric='accuracy precision')
dist_params = dict(backend='nccl')
log_level = 'INFO'
load_from = '../pre_train_mode/swin_v2.pth'
resume_from = None
workflow = [('train', 1)]
work_dir = './work_dirs\swinv2-base-w16_16xb64_in1k-256px'
gpu_ids = [0]
