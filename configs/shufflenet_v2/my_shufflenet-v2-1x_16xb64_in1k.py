...
optimizer = dict(type='Adam', lr=0.0001, betas=(0.9, 0.999), eps=1e-08, weight_decay=0, amsgrad=False)
...
log_level = 'INFO'
load_from = 'D:/Python项目/mmclassification-master/tools/work_dirs/shufflenet-v2-1x_16xb64_in1k/shufflenet_v2.pth'
resume_from = None
