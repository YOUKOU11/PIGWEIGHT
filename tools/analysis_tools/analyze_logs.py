...
# plot_curve D:\Python项目\mmclassification-master\tools\work_dirs\resnet18_8xb32_in1k\20230315_142505.log.json --keys  loss accuracy_top-1
# plot_curve
# D:\Python项目\mmclassification-master\tools\work_dirs\resnet18_8xb32_in1k\train.log.json
# D:\Python项目\mmclassification-master\tools\work_dirs\resnet18_8xb32_in1k\val.log.json
# --keys
# accuracy_top-1
# --out
# D:\Python项目\mmclassification-master\tools\work_dirs\log_figures\acc2.jpg
...
def plot_phase_val(metric, log_dict, epochs, curve_label, json_log):
    ...
    plt.ylabel('Accuracy')
    plt.title("Loss Analyze")
    # plt.plot(xs, ys, label='Val_Accuracy', linewidth=0.75)
    plt.plot(xs, ys, label=curve_label, linewidth=0.75)
...
def plot_curve_helper(log_dicts, metrics, args, legend):
    ...
    for i, log_dict in enumerate(log_dicts):
        ...
        for j, metric in enumerate(metrics):
            ...
            curve_label1 = curve_label.split('_')[0]
            curve_label2 = curve_label.split('_')[1]
            print(curve_label1, curve_label2)
            if curve_label2 != 'loss':
                curve_label = curve_label1 + '_' + curve_label2 + '_loss'
            else:
                curve_label = curve_label1 + '_' + curve_label2
            print(curve_label)
